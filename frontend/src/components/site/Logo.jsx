...
const Logo = ({ className = '' }) => (
  <a href="#home" className={`flex items-center gap-2 group ${className}`}>
    ...
    <div className="leading-none">
      <div className="font-display font-black text-white text-xl tracking-tight">Koçum<span className="text-gold">Sınav</span></div>
      <div className="text-[10px] uppercase tracking-[0.25em] text-gold/70 mt-0.5">Mentorluk & Rehberlik</div>
    </div>
  </a>
);
